    ...
    if (!isSupabaseConfigured || !supabase) {
      ...
      if (!existing) {
        const defaultUsers = [
          ...
          {
            id: '4155f554-a955-442a-af69-75288a66a4d7',
            email: 'jacques@gmail.com',
            name: 'Jacques Vasconcellos',
            username: 'jac',
            phone: '21965113553',
            password: '123',
            profile: {
              id: '4155f554-a955-442a-af69-75288a66a4d7',
              email: 'jacques@gmail.com',
              full_name: 'Jacques Vasconcellos',
              username: 'jac',
              phone: '21965113553',
              role: 'collaborator',
              collaborator_category_id: '2f14af59-2e34-432f-85a9-a9cc08802431',
              collaborator_category: { id: '2f14af59-2e34-432f-85a9-a9cc08802431', name: 'Entregador', description: 'Entregas e delivery', is_active: true },
              is_active: true,
              created_at: new Date().toISOString()
            }
          }
